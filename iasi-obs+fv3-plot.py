...
#------------------------------------------------------------------------------
 #griddir = '/work/noaa/gsienkf/weihuang/UFS-RNR-tools/JEDI.FV3-increments/grid/C96/'
  ...
  casedir = '/work2/noaa/gsienkf/weihuang/jedi/case_study/iasi/run_80.40t1n_36p'
...
#------------------------------------------------------------------------------
  ...
  if(addobs):
    casedir = '/work2/noaa/gsienkf/weihuang/jedi/case_study/iasi/run_80.40t1n_36p'
    filename = '%s/manmade-iasi-obs/iasi_metop-a_obs_2020121500_m.nc4' %(casedir)
